...
{
	stack_p stack = static_cast<stack_p>(calloc(1, sizeof(stack_t1)));//gai

	stack->head = static_cast<dlist_pp>(calloc(1, sizeof(dlist_pp)));//gai
	return stack;
}
...
{
	dlist_p nodeptr = static_cast<dlist_p>(calloc(1, sizeof(dlist_t)));
